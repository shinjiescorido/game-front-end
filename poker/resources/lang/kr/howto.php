...
return [
    ...
    'bonus_plus_payout_1' => '로얄 플러시 ',
    'bonus_plus_payout_2' => '스트레이트 플러시',
    'bonus_plus_payout_3' => '포카드',
    'bonus_plus_payout_4' => '풀하우스',
    'bonus_plus_payout_5' => '플러시',
    'bonus_plus_payout_6' => '스트레이트',
    ...
    'game_statistics_img_pc'          => '<img src="/img/howtoplay/dark/pc/stats_kr.png" width="100%" alt="game stats" class="roadmap changeImg" />',
    ...
    'bonus_payouts_img_pc'            => '<img src="/img/howtoplay/dark/pc/payouts_kr.png", alt="bonus payouts" class="pay changeImg" />',
    'bonus_payouts_img_mb'            => '<img src="/img/howtoplay/dark/mb/payouts_kr.png", alt="bonus payouts" class="pay changeImg" />',
    'bonus_payouts_desc_pc'           => '플레이어 홀 카드의 보너스 배당 정보를 표시합니다.',
    'bonus_payouts_desc_mb'           => '플레이어 홀 카드의 보너스 배당<br/>정보를 표시합니다.',

    'player_info'                     => '플레이어 정보',
    'player_info_img_pc'              => '<img src="/img/howtoplay/dark/pc/player_info_kr.png", alt="game player info" class="changeImg" />',
    'player_info_img_mb'              => '<img src="/img/howtoplay/dark/mb/player_info_kr.png", alt="game player info" class="changeImg" />',
    ...
    'bet_info'                        => '베팅 금액 정보',
    'bet_info_img_pc'                 => '<img src="/img/howtoplay/dark/pc/bet_info_kr.png", alt="game bet info" class="changeImg" />',
    'bet_info_img_mb'                 => '<img src="/img/howtoplay/dark/mb/bet_info_kr.png", alt="game bet info" class="changeImg" />',
    ...
    'channels_bet_limit_img'          => '<img src="/img/howtoplay/dark/pc/channels_kr.png" alt="channels" class="changeImg" />',
    ...
    'betting_buttons_desc_pc'         => '
                                         ...
                                         <img src="/img/howtoplay/dark/pc/betting_buttons_kr.png" class="betting-btn" alt="betting buttons" />

                                         <p>이전 베팅과 동일하게 베팅을 하고자하는 경우 <img src="/img/howtoplay/dark/undo_btn_kr.png" width="55px" alt="undo" /> 버튼이 변경된 자리의 <img src="/img/howtoplay/dark/repeat_btn_kr.png" width="55px" alt="repeat"/>
    ...
    'betting_buttons_desc_mb'         => '
                                         ...
                                         <img src="/img/howtoplay/dark/mb/betting_buttons_kr.png" class="betting-btn" alt="betting buttons" />

                                         <p>이전 베팅과 동일하게 베팅을 하고자하는 경우<img src="/img/howtoplay/dark/undo_btn_kr.png" alt="undo" /> 버튼이 변경된 자리의<img src="/img/howtoplay/dark/repeat_btn_kr.png" alt="repeat"/>
                                         버튼을 터치하여 지난 베팅을 반복 베팅할 수 있습니다.
                                         </p>',

    'chips_rack'                      => '칩 세팅',
    'chips_rack_desc'                 => '기본 칩 또는 플레이어가 선택한 칩이 표시됩니다.',
    'chips_rack_img_pc'               => '<img src="/img/howtoplay/dark/pc/chip_rack_kr.png" alt="modify chips" class="chip racks">',
    'chips_rack_img_mb'               => '<img src="/img/howtoplay/dark/mb/chip_rack_kr.png" alt="modify chips" class="chip racks">',

    'menu_toggle'                     => '메뉴 버튼',
    'menu_toggle_desc'                => '<img src="/img/howtoplay/dark/mb/menu_toggle.png" width="7%" alt="menu toggle" class="menu_toggle"> 버튼을 터치하면 전체 메뉴창이 표시됩니다.',

    'modify_chips'                    => '사용자 칩 설정',
    'modify_chips_desc_pc'            => '
                                         <p>설정된 칩을 변경하고자 하는 경우 게임 메뉴의 <img src="/img/howtoplay/dark/pc/modifychips_btn_kr.jpg" width="50px" alt="modify chips" class="changeImg" /> 버튼을 클릭하여 칩을 교체할 수 있습니다.
                                         상단의 칩 세팅에서<br/>교체하고자 하는 칩을 먼저 클릭하여 제거한 뒤 하단의 칩을<br/>선택하고 <img src="/img/howtoplay/dark/applychips_btn_kr.jpg" width="15%" alt="apply" /> 버튼을 클릭하면 적용됩니다.
                                         <br/><img src="/img/howtoplay/dark/clearchips_btn_kr.png" width="15%" alt="clear" class="changeImg" /> 버튼을 클릭하면 기본 설정 칩으로 변경됩니다.</p>
                                         ',
    'modify_chips_desc_mb'            => '
                                         <p>설정된 칩을 변경하고자 하는 경우 게임 메뉴의 <img src="/img/howtoplay/dark/mb/modifychips_btn.png" width="7%" alt="modify chips" class="changeImg" /> 버튼을 터치하여 칩을 교체할 수 있습니다. 상단의 칩 세팅에서 교체하고자 하는 칩을 먼저<br/>터치하여 제거한 뒤 하단의 칩을 선택하고 <img src="/img/howtoplay/dark/applychips_btn_kr.jpg" width="12%" alt="apply" /> 버튼을 터치하면<br/>적용됩니다. <img src="/img/howtoplay/dark/clearchips_btn_kr.png" width="12%" alt="clear" class="changeImg" /> 버튼을 터치하면 기본 설정 칩으로 변경됩니다. </p>
                                           ',
    'modify_chips_img_pc'             => '<img src="/img/howtoplay/dark/pc/modify_chips_kr.png" alt="modify chips" class="modify_chip changeImg">',
    'modify_chips_img_mb'             => '<img src="/img/howtoplay/dark/mb/modify_chips_kr.png" alt="modify chips" class="modify_chip changeImg">',
