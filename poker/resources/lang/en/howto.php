...
return [
    ...
    'bonus_plus_payout_1' => 'Royal Flush',
    'bonus_plus_payout_2' => 'Straight Flush',
    'bonus_plus_payout_3' => 'Four of a Kind',
    'bonus_plus_payout_4' => 'Full House',
    'bonus_plus_payout_5' => 'Flush',
    'bonus_plus_payout_6' => 'Straight',
   ...
   'multibet_desc'                    => 'The Multibet Panel, when inactive, displays the basic info of a game. Click <img src="/img/howtoplay/preview.png" alt="game statistics" class="multibetimg"/>
   ...
   'multibet_info'                    => '<img src="/img/howtoplay/dark/multibet_active_en.png" alt="game statistics" class="changeImg multibetinfoimg"/>
                                         ...
                                         Click <img src="/img/howtoplay/close.png" alt="game statistics"/> to close an active game or <img src="/img/howtoplay/minimize.png" alt="game statistics"/> to minimize the Multibet Panel.</p>',
   ...
   'betting_buttons_desc_pc'          => '
                                         ...
                                         <p>The Undo Button
                                         <img src="/img/howtoplay/dark/undo_btn_en.png" width="55px" alt="undo"/> changes to a Repeat Button <img src="/img/howtoplay/dark/repeat_btn_en.png" width="55px" alt="repeat"/>if you want to repeat a previous bet.</p>
                                         ',
   'betting_buttons_desc_mb'          => '
                                         ...
                                         <p>The Undo Button
                                         <img src="/img/howtoplay/dark/undo_btn_en.png" alt="undo"/> changes to a Repeat Button <img src="/img/howtoplay/dark/repeat_btn_en.png" alt="repeat"/>if you want to repeat a previous bet.</p>
                                         ',
   ...
   'menu_toggle_desc'                 => 'Tap the <img src="/img/howtoplay/dark/mb/menu_toggle.png" width="7%" alt="menu toggle" class="menu_toggle"> icon to display the full list of menu options.',

   'modify_chips'                     => 'Modify Chips',
   'modify_chips_desc_pc'             => '
                                         <p>To customize your chip rack based on your preference, click on the <img src="/img/howtoplay/dark/pc/modifychips_btn_en.png" width="50px" alt="modify chips" class="changeImg" /> button at the game menu. To modify chips, click on the chip you want to replace and click the replacement chip after. Click <img src="/img/howtoplay/dark/applychips_btn_en.png" width="15%" alt="apply" /> once you’re okay with your new set of chips or click <img src="/img/howtoplay/dark/clearchips_btn_en.png" width="15%" alt="clear" class="changeImg" /> to clear all chips and start over.</p>
                                         ',
   'modify_chips_desc_mb'             => '
                                         <p>To customize your chip rack based on your preference, tap on the <img src="/img/howtoplay/dark/mb/modifychips_btn.png" width="7%" alt="modify chips" class="changeImg" /> button at the game menu. To modify chips, tap on the chip you want to replace and tap the replacement chip after. Tap <img src="/img/howtoplay/dark/applychips_btn_en.png" width="12%" alt="apply" /> once you’re okay with your new set of chips or tap <img src="/img/howtoplay/dark/clearchips_btn_en.png" width="12%" alt="clear" class="changeImg" /> to clear all chips and start over.</p>
                                           ',
