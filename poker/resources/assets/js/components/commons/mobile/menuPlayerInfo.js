...
export default() => {
	instance = instance || new blu.Component({
      ...
      this.scaleX = this.scaleY = 1.5;
			...
			//Header Text
			this._headerTxt = new createjs.Text(window.language.menu.playerinfo,window.language.locale == "zh" ? "bold 20px arial" : "bold 15px arial", this.context.theme_color[window.theme].labelcolor);
			...
			this.balance = new createjs.Text(window.casino == "SS" ? moneyFormat(window.user_money) : numberWithCommas(window.user_money),"13px arial", this.context.theme_color[window.theme].modal_txt_color);
			...
			this.channel = new createjs.Text("Poker "+window.tableNum,"13px arial", this.context.theme_color[window.theme].modal_txt_color);
		...
		updatePlayerInfo(balance, round, dealer) {
			...
			// if(dealer) {
			// 	console.log(this.dealer,"asdsaadsdsd")
