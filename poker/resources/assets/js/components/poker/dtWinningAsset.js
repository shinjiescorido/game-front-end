...
export default() => {
	instance = instance || new blu.Component({
		...
		main() {
			...
			this.winning_asset["dragon"].x = this.context.stage.baseWidth/2 - 110;
			this.winning_asset["dragon"].y = 20;
			//==tiger winning asset
			...
			this.winning_asset["tiger"].x = this.context.stage.baseWidth/2- 110;
			this.winning_asset["tiger"].y = 20;
			//==tie winning asset
			...
			this.winning_asset["tie"].x = this.context.stage.baseWidth/2- 110;
			this.winning_asset["tie"].y = 20
