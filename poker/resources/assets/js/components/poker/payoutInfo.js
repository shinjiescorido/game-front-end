...
export default() => {
	instance = instance || new blu.Component({
		main() {
			this.label =  new createjs.Text(window.language.game_specific.bonuspayout.toUpperCase(), window.language.locale == "zh" && window.bet_type !='b' ? "23px lato-black" : "18px lato-black",this.context.theme_color[window.theme].text_color);
			this.label.textAlign = "center";
			this.label.x = 98;
			this.label.y = 9;

			this.x = 1008;
			this.y = this.context.context.height - 190
			this.addChild(this.label);

			this.win_1 = {
				label : new createjs.Text(window.language.payouts.players_whole_card_1, window.language.locale == "zh" ? "17px latoRegular" : "14px latoRegular",this.context.theme_color[window.theme].text_color),
				payout : new createjs.Text("30","14px latoRegular",this.context.theme_color[window.theme].text_color)
			}


			this.win_1.label.y = 40;
			this.win_1.payout.y = 40 ;
			this.win_1.payout.x = 186;
			this.win_1.payout.textAlign = "right";
			this.addChild(this.win_1.label, this.win_1.payout);

			this.win_2 = {
				label : new createjs.Text(window.language.payouts.players_whole_card_2, window.language.locale == "zh" ? "17px latoRegular" : "14px latoRegular",this.context.theme_color[window.theme].text_color),
				payout : new createjs.Text("25","14px latoRegular",this.context.theme_color[window.theme].text_color)
			}

			this.win_2.label.y = 60;
			this.win_2.payout.y = 60;
			this.win_2.payout.x = 186;
			this.win_2.payout.textAlign = "right";
			this.addChild(this.win_2.label, this.win_2.payout);

			this.win_3 = {
				label : new createjs.Text(window.language.payouts.players_whole_card_3, window.language.locale == "zh" ? "17px latoRegular" : "14px latoRegular",this.context.theme_color[window.theme].text_color),
				payout : new createjs.Text("20","14px latoRegular",this.context.theme_color[window.theme].text_color)
			}

			this.win_3.label.y = 80;
			this.win_3.payout.y = 80;
			this.win_3.payout.x = 186;
			this.win_3.payout.textAlign = "right";
			this.addChild(this.win_3.label, this.win_3.payout);

			this.win_4 = {
				label : new createjs.Text(window.language.payouts.players_whole_card_4, window.language.locale == "zh" ? "17px latoRegular" : "14px latoRegular",this.context.theme_color[window.theme].text_color),
				payout : new createjs.Text("15","14px latoRegular",this.context.theme_color[window.theme].text_color)
			}

			this.win_4.label.y = 100;
			this.win_4.payout.y = 100;
			this.win_4.payout.x = 186;
			this.win_4.payout.textAlign = "right";
			this.addChild(this.win_4.label, this.win_4.payout);

			this.win_5 = {
				label : new createjs.Text(window.language.payouts.players_whole_card_5, window.language.locale == "zh" ? "17px latoRegular" : "14px latoRegular",this.context.theme_color[window.theme].text_color),
				payout : new createjs.Text("10","14px latoRegular",this.context.theme_color[window.theme].text_color)
			}

			this.win_5.label.y = 120;
			this.win_5.payout.y = 120;
			this.win_5.payout.x = 186;
			this.win_5.payout.textAlign = "right";
			this.addChild(this.win_5.label, this.win_5.payout);

			this.win_6 = {
				label : new createjs.Text(window.language.payouts.players_whole_card_6, window.language.locale == "zh" ? "17px latoRegular" : "14px latoRegular",this.context.theme_color[window.theme].text_color),
				payout : new createjs.Text("5","14px latoRegular",this.context.theme_color[window.theme].text_color)
			}

			this.win_6.label.y = 140;
      if(window.language.locale == 'jp')  this.win_6.label.font = "12px latoRegular";
			this.win_6.payout.y = 140;
			this.win_6.payout.x = 186;
			this.win_6.payout.textAlign = "right";
			this.addChild(this.win_6.label, this.win_6.payout);

			this.win_7 = {
				label : new createjs.Text(window.language.payouts.players_whole_card_7, window.language.locale == "zh" ? "17px latoRegular" : "14px latoRegular",this.context.theme_color[window.theme].text_color),
				payout : new createjs.Text("3","14px latoRegular",this.context.theme_color[window.theme].text_color)
			}

			this.win_7.label.y = 158;
			this.win_7.payout.y = 158;
			this.win_7.payout.x = 186;
		...
		change_page(payout_page, arrow_left, arrow_right) {
			...
			if(payout_page == 'bonusplus'){
				...
				for(let i=1;i<7;i++){
					this['win_'+i].label.text = window.language.payouts['poker_hand_ranking_list_'+i];
			...
			if(payout_page == 'badbeat'){
				...
				for(let i=1;i<6;i++){//no royal flush in badbeat
					let list_index = i + 1;
					this['win_'+i].label.text = window.language.payouts['poker_hand_ranking_list_'+list_index];
