...
export default()=> {
	return new blu.Component({
		main() {
            ...
            this.bg.graphics.beginFill(this.context.theme_color[window.theme].base_color).drawRect(-10,-12,615, 150);
            this.addChild(this.bg);

            this.overlay = new createjs.Shape();
            this.overlay.graphics.beginFill('rgba(0,0,0,0.6)').drawRect(-10,-12,615, 150);
			...
			community_bg.graphics.beginFill("rgba(255,255,255,0.2)").drawRoundRect(150,0,295,128,10);
            ...
            this.playerCards.forEach((player, x) => {
                ...
                this.playerCardObj[x].x = (x*50) + 500;
            ...
            this.communityCards.forEach((community, x) => {
                self.communityCardObj[x] = createCardSprite(self, 80, 120,"new_cards");
                ...
                this.communityCardObj[x].x = (x*50) + 198;
            ...
            this.dealerCards.forEach((dealer, x) => {
                self.dealerCardObj[x] = createCardSprite(self, 80, 120,"new_cards");
                ...
                this.dealerCardObj[x].x = (x*50) + 45;
        ...
        {
            this.bg.graphics.beginFill(this.context.theme_color[new_theme].base_color).drawRect(-10,-12,615, 150);
        },
