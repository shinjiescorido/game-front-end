...
export default (self) => {
	...
	instance = instance || new blu.Component({
		...
		main() {
			this.x = 1009;
			this.y = this.context.stage.baseHeight  - 280;
			...
			check_1.scaleX = check_1.scaleY = 0.7;
			check_2.scaleX = check_2.scaleY = 0.7;
			check_1.y = check_2.y = -12;
			check_1.x = check_2.x = 2;

			let text = new createjs.Text("RAISE" , "20px helvetica", "#fff");
			...
			this.flop_bet_button.scaleX = 0.83;
			this.flop_bet_button.scaleY = 0.83;
			...
			let text2 = new createjs.Text("CALL" , "20px arial", "#fff");
			...
			this.turn_bet_button.scaleX = 0.83;
			this.turn_bet_button.scaleY = 0.83;
			this.turn_bet_button.y = -0.8;
			this.addChild(this.turn_bet_button);

			// === river bet button

			let text3 = new createjs.Text("CALL" , "20px helvetica", "#fff");
			...
			this.river_bet_button.scaleX = 0.83;
			this.river_bet_button.scaleY = 0.83;
			...
			fold_check_btn.graphics.beginLinearGradientFill(["#a22828","#cc282a","#a22828"],[0,0.5,1], 30,0,80,0,140,0).drawCircle(57,55,43);
			...
			fold_check_btn_1.y = fold_check_btn_2.y = 8;


			this.fold_check_btn = new createjs.Container();
			this.fold_check_btn.addChild(fold_check_btn, fold_check_btn_1, fold_check_btn_2);
			this.fold_check_btn.x = 87.5
			this.fold_check_btn.scaleX = this.fold_check_btn.scaleY =  0.86
			this.fold_check_btn.y = -36
			this.fold_check_btn.visible = false;
			this.addChild(this.fold_check_btn)

			let fold_check_text = new createjs.Text("FOLD" , "16px arial", "#fff");
	    ...
	    winTableChipsAnimation(chips) {
	      	for (var x = 0; x < chips.length; x++) {
		        createjs.Tween.get(chips[x])
		          .to({
		            alpha: 0,
		            x: this.context.component_betDetails.x + 20,
