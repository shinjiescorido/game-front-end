{{-- Chat container --}}
@if(isset($_GET['token']))
	<div class="junket-chat-con"></div>
@endif

{{-- Junket modal --}}
<div class="junket-confirm">
	<div class="mdl_overlay"></div>
	<div class="mdl_bg -closeroom"> {{-- close room --}}
	...
	<div class="mdl_bg -password"> {{-- change password --}}
		<div class="password-con">
			...
			<div class="mdl_message-error -inc_pass">Incorrect password.</div>
			...
			<div class="mdl_message-error -inc_match">Password doesn't match.</div>
		</div>
	...
	<div class="mdl_bg -success"> {{-- success modal --}}
		<div class="mdl_warning_ico"></div>
