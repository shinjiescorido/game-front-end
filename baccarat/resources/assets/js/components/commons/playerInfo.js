...
export default() => {
   ...
   //    // console.log(":::: > ", obj);
			...
			// this.bar_blue.updateCache()
			// this.bar_red.scaleX = (total_lose/obj.total_bets);
			// this.bar_red.updateCache()
		...
		changeTheme(new_theme) {
			this.background.graphics.clear().beginFill(this.context.theme_color[new_theme].base_color).drawRect(-28,-20,216,180);
