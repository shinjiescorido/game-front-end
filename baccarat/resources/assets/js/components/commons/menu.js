...
export default () => {
  ...
  return new blu.Component({
    ...
    main() {
      ...
      //   window.language.menu.videosettings,
      ...
      //   this.menu_label[x] = new createjs.Text(menu_text[x], window.language.locale == "zh" ? "17px Lato" : "12px Lato" , this.context.theme_color[window.theme].menu_text_color);
      //   this.menu_label[x].y = (this.menu[x].y) + 68 - 10.2;
