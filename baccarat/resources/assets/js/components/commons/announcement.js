...
export default () => {
	instance = instance || new blu.Component({
		...
		setAnnouncement (data, main) {
			...
			announcementTextBg.graphics.beginLinearGradientFill(['#59090a', 'rgba(89, 9, 10, 0.1)'], [0,1],0,0,1470,0).drawRect(0,0,1470,56); //.drawRoundRectComplex(0, 0, 550, 56, 0, 0, 10, 0); 
	        ...
	        marquee_con.mask.graphics.beginFill("#fff").drawRect(0, 0, 1460, 33);
	        marquee_con.mask.x = announcementText.x;
	        marquee_con.mask.y = announcementText.y;

	        let twin = announcementText.clone();
	        twin.x = announcementText.x + 1544; //textbounds.width
