...
export default() => {
    instance = instance || new createjs.Container();
    instance.tween_time = null;
    instance.timer = (time, totalTime) => {
        if(timer_circle) {
            instance.removeChild(timer_circle)
        }
        ...
        timer_circle.x = 85;
        timer_circle.y = 85;
        instance.addChild(timer_circle);
        var arcCommand = timer_circle.graphics.arc(0, 0, 55, 0, startAngle).command;
