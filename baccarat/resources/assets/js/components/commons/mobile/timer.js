...
export default () => {
	instance = instance || new blu.Component({
		...
		main() {
			...
			this.x = this.context.component_gameButtons.x;
			this.y = this.context.component_gameButtons.y;

			this.timer_instance.scaleX = 0.85;
			this.timer_instance.scaleY = 0.85;
			this.timer_instance.x = buttonposx;
			this.timer_instance.y = buttonposy;
