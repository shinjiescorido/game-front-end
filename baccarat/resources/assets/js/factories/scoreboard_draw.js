...
scoreboard = function (item, mark) {
  ...
  switch(item) {
    ...
    if (mark == "d"|| mark == "b"|| mark == "c" || mark == "g" || mark == "h" || mark == "i" || mark == "j") {
      ...
      circle_text = new createjs.Text("D", "bold 34px lato-black","#fff");
      ...
      circle_text = new createjs.Text("T", "bold 34px lato-black","#fff");
      circle_text.set({textAlign: 'center', textBaseline: 'middle', x :circle.x, y:circle.y});
      instance[mark].addChild(circle, circle_text);
...
dragontigerRoadmap = function (radius, r2) {
  ...
  this.play = function (mark, font, ss) {
    ...
    switch (mark) {
      ...
      //big road
      case "big-d":
      this.circle.graphics.clear().ss(ss ? ss : 2).s(dragon_color).drawCircle(0,0,r);
      this.instance.addChild(this.circle);
      break;
      case "big-t":
      this.circle.graphics.clear().ss(ss ? ss : 2).s("transparent").drawCircle(0,0,r);
      this.instance.addChild(this.circle);
      break;
      case "big-z":
      this.circle.graphics.clear().ss(ss ? ss : 2).s(tiger_color).drawCircle(0,0,r);
      this.instance.addChild(this.circle);
      break;
      case "big-s":
      this.circle.graphics.clear().ss(ss ? ss : 2).s("transparent").drawCircle(0,0,r);
      ...
      break;
      case "bigeye-b":
      this.circle.graphics.clear().ss(ss ? ss : 1.5).s(dragon_color).drawCircle(0,0,r);
      this.instance.addChild(this.circle);
      break;
      case "bigeye-r":
      this.circle.graphics.clear().ss(ss ? ss : 1.5).s(tiger_color).drawCircle(0,0,r);
      this.instance.addChild(this.circle);
      break;
      case "small-b":
      this.circle.graphics.clear().beginFill(dragon_color).drawCircle(0,0,r);
...
baccaratRoadmap = function (radius, r2) {
  ...
  this.play = function (mark, font, ss) {
    ...
    switch(mark) {
      ...
      //big road
      case "big-b":
      this.circle.graphics.clear().ss(ss ? ss : 2).s(banker_color).drawCircle(0,0,r);
      this.instance.addChild(this.circle);
      break;
      case "big-p":
      this.circle.graphics.clear().ss(ss ? ss : 2).s(player_color).drawCircle(0,0,r);
      this.instance.addChild(this.circle);
      break;
      case "big-q":
      this.circle.graphics.clear().ss(ss ? ss : 2).s(banker_color).drawCircle(0,0,r);
      ...
      break;
      case "big-l":
      this.circle.graphics.clear().ss(ss ? ss : 2).s(supersix_color).drawCircle(0,0,r);
      this.instance.addChild(this.circle);
      break;
      case "big-m":
      this.circle.graphics.clear().ss(ss ? ss : 2).s(supersix_color).drawCircle(0,0,r);
...
export default {scoreboard, dragontigerRoadmap, baccaratRoadmap }
