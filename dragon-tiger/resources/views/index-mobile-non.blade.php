  ...
  <body>
    ...
    <div class="container-wrap">
      <div class="container" id="SUPER-CONTAINER">
        ...
        <div class="betlog-result"> {{--betlog-result--}}
				<div class="betlog-result__head">
					<span>{!! trans('ingame-web.com_sub_menuarea_winningresult') !!}</span>
					<i class="ico-close"></i>
				</div>
				<div class="betlog-result__body">
					<div class="betlog-result-con">
						<div class="betlog-result__info clearfix">
							<div class="betlog-info__items betlog-info--gameno">
								<span></span>
							</div>
							<div class="betlog-info__items betlog-info--date">
								<span></span>
							</div>
						</div>
						<div class="betlog-result-holder">
              <div class="betlog-result--dragontiger">
                {{-- <span class="dt-normal">T</span>
                <span class="dt-normal">O</span>
                <span class="dt-normal">B</span>
                <span class="dt-suite-club"></span> --}}
              </div>
						</div>

            <div class="betlog-result-cardholder clearfix">
              {{-- <div class="betlog-result-card__items -dragon">
                <div class="cardholder-con -dragon">
                  <span class="card-0000"></span>
                </div>
                <span class="cardresult--value -dragon">10</span>
              </div>
              <div class="betlog-result-card__items -tiger">
                <div class="cardholder-con -tiger">
                  <span class="card-0045"></span>
                </div>
                <span class="cardresult--value -tiger">10</span>
              </div> --}}
						</div>
					</div>
					<div class="betlog-table table--betlog tbl--head">
						<div class="betlog-tr">
					...
					<div class="betlog-table-con">
						<div class="betlog-table table--betlog tbl--body">
							<div class="betlog-tr">
								<div class="betlog-td -bettype"><span></span></div>
								<div class="betlog-td -bets"><span></span></div>
								<div class="betlog-td -winlose"><span></span></div>
							</div>
						</div>
					</div>
        ...
        <!-- <canvas id="canvasTextbox" width="200" height="50"></canvas> -->
