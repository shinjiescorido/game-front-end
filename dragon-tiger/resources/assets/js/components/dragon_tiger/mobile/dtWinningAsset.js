...
export default() => {
	instance = instance || new blu.Component({
		...
		main() {
			...
			this.winning_asset["dragon"].x = this.context.stage.baseWidth/2 - 95;
			...
			this.winning_asset["tiger"].x = this.context.stage.baseWidth/2- 95;
			...
			this.winning_asset["tie"].x = this.context.stage.baseWidth/2- 90;
