...
export default() => {
    ...
    instance.timer = (time, totalTime) => {
      ...
      var strokeCommand = instance.timer_circle.graphics.ss(5).s("rgb(97,168,85)").command;
      ...
      instance.timer_circle.x = 0;
      instance.timer_circle.y = 0;
      instance.addChild(instance.timer_circle);
      var arcCommand = instance.timer_circle.graphics.arc(0, 0, 28, 0, startAngle).command;
