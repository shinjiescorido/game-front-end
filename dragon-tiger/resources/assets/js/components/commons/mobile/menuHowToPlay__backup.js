...
export default() => {
    ...
    pageGameRules() {
      ...
      let font_h = "bold 24px lato-regular";
      let font_s = "22px lato-regular";
      let lineheight_b = 26;
      ...
      tablehead.bg.graphics.beginFill("#b4b4b4").drawRect(-1, 0, 702, 30);
      tablehead.bg.x = 5;
      tablehead.a.x = tablehead.bg.x + 65;
      tablehead.b.x = tablehead.bg.x + 180;
      tablehead.c.x = tablehead.bg.x + 465;

      let table = this.drawTable([130, 100, 470], 7, 700);
    ...
    pageGameplayTutorial() {
      ...
      Object.values(image).forEach((o,i) => {
        o.x = 40;
        if(o.image.width > this._modalWidth - 10) {
          o.scaleX = o.scaleY = (this._modalWidth - 10) / o.image.width;
        }
      ...
      body.g.y = title.f.y + title.f.height + 20;
        title.a.x = title.b.x = title.d.x = title.e.x = title.f.x = linewidth_b * 0.5;
        body.a.lineWidth = body.b.lineWidth = body.e.lineWidth = body.f.lineWidth = body.g.lineWidth = linewidth_b * 0.4;
        body.a.x = body.b.x = body.e.x = body.f.x = body.g.x = linewidth_b * 0.5;
        image.a.y = title.a.y;
        image.b.y = title.b.y;
        image.d.y = title.d.y;
        image.e.y = title.e.y;
