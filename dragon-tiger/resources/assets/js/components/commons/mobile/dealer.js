...
export default() => {
	instance = instance || new blu.Component({
		...
		main() {
			...
			//dealer name init
			this.dealer_name = new createjs.Text("Sunshine","20px arial",this.context.theme_color[window.theme].text_color);
			this.dealer_name.x = this.dealer_image.x + 80;
			this.dealer_name.y = this.dealer_image.y + 10;
