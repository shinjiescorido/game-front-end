...
export default() => {
	instance = instance || new blu.Component({
		main() {
			...
			this.bg.graphics.beginFill(this.context.theme_color[window.theme].base_color).drawRect(-20,10,235,150);
      ...
      if(textbounds.width > 120) {
		...
		changeTheme(new_theme) {
			this.bg.graphics.beginFill(this.context.theme_color[new_theme].base_color).drawRect(-20,10,235,150);
