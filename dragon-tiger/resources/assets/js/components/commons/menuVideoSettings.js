...
export default(links) => {
	...
	instance = instance || new blu.Component({
		main() {
			...
			//Header Text
			this._headerTxt = new createjs.Text(window.language2.com_sub_menuarea_videosettings, window.language.locale == "zh" ? "bold 20px arial" : "bold 15px arial", this.context.theme_color[window.theme].labelcolor);
			...
			this.refVideoTxt = new createjs.Text(window.language2.com_sub_menuarea_refreshvideo, window.language.locale == "zh" ? "bold 18px arial" : "bold 13px arial", this.context.theme_color[window.theme].labelcolor);
      ...
      let spriteData = {
        images: [("/img/menu/refreshvid_icon.png")],
        frames: {
          width: 23,
          height: 26
        },
