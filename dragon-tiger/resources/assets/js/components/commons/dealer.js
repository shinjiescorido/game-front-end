...
export default() => {
	instance = instance || new blu.Component({
		...
		main() {
			...
			// this.bg.graphics.beginFill(this.context.theme_color[window.theme].base_color).drawRect(-50,0,250,190);
		...
		changeTheme(new_theme) {
			...
			// this.bg.graphics.clear().beginFill(this.context.theme_color[new_theme].base_color).drawRect(-50,0,250,190);
