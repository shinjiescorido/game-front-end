...
dragontigerRoadmap = function (radius, r2) {
  ...
  this.play = function (mark, font, ss) {
    ...
    switch (mark) {
      ...
      //big road
      case "big-d":
      this.circle.graphics.clear().ss(ss ? ss : 1.8).s(dragon_color).drawCircle(0,0,r);
      this.instance.addChild(this.circle);
      break;
      case "big-t":
      this.circle.graphics.clear().ss(ss ? ss : 1.8).s("transparent").drawCircle(0,0,r);
      this.instance.addChild(this.circle);
      break;
      case "big-z":
      this.circle.graphics.clear().ss(ss ? ss : 1.8).s(tiger_color).drawCircle(0,0,r);
      this.instance.addChild(this.circle);
      break;
      case "big-s":
      this.circle.graphics.clear().ss(ss ? ss : 1.8).s("transparent").drawCircle(0,0,r);
      ...
      break;
      case "bigeye-b":
      this.circle.graphics.clear().ss(ss ? ss : 1.3).s(dragon_color).drawCircle(0,0,r);
      this.instance.addChild(this.circle);
      break;
      case "bigeye-r":
      this.circle.graphics.clear().ss(ss ? ss : 1.3).s(tiger_color).drawCircle(0,0,r);
      this.instance.addChild(this.circle);
      break;
      case "small-b":
      this.circle.graphics.clear().beginFill(dragon_color).drawCircle(0,0,r);
