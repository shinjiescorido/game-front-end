...
return [
  ...
  'MB_multibet_img'        => '<img src="/img/menu/howtoplay/dark/multibet_en.png" alt="multibet" class="changeImg" />',

  'multibet_desc'          => '
                              The Multibet Panel, when inactive, displays the basic info of a game. Click <img src="/img/menu/howtoplay/preview.png" alt="game statistics" class="multibetimg"/>
  ...
  'multibet_info'          => '<img src="/img/menu/howtoplay/dark/multibet_active_en.png" alt="game statistics" class="changeImg multibetinfoimg"/>
                               ...
                               Click <img src="/img/menu/howtoplay/close.png" alt="game statistics"/> to close an active game or <img src="/img/menu/howtoplay/minimize.png" alt="game statistics"/> to minimize the Multibet Panel.
                               </p>',
  ...
  'dealerinfo_img'         => '<img src="/img/menu/howtoplay/dark/dealer_info.png" alt="dealer info" class="changeImg" />',
  'MB_dealerinfo_img'      => '<img src="/img/menu/howtoplay/dark/dealer_info.png" alt="dealer info" />',
  'dealerinfo_desc'        => "Shows the dealer's name, game number and the winning percentage of Dragon, Tiger and Tie.",

  'MB_dealers_info_chanel_bet_img'  => "<img src ='/img/menu/howtoplay/dark/dealer_info_mb.png' alt ='info' class='changeImg' />",
  ...
  'gamestatistics_desc'    => '<p>Displays the roadmap summary, next game prediction and the number of deals per shoe. Updates after every game; and resets after every shoe change.</p>
                               <p>Click <img src="/img/menu/howtoplay/dragon_predictions.png" alt="dragon_predictions" /> for Dragon predictions and <img src="/img/menu/howtoplay/tiger_predictions.png" alt="tiger_predictions" /> for Tiger predictions.</p>',
  ...
  'MB_gamestatistics_desc' => '<p>Displays the roadmap summary and next game prediction. Updates after every game; and resets after every shoe change.</p>
                               <p>Tap <img src="/img/menu/howtoplay/dragon_predictions.png" alt="dragon_predictions" /> for Dragon predictions and <img src="/img/menu/howtoplay/tiger_predictions.png" alt="tiger_predictions" /> for Tiger Predictions.
                               Double-tap anywhere to enlarge Game Statistics.</p>
                               <img src="/img/menu/howtoplay/game_stats1_mb.png" alt="" class="img-res" />',

  'playerinfo_title'       => 'Player Info',
  'playerinfo_img'         => '<img src="/img/menu/howtoplay/dark/player_info_en.png" alt="player info" class="changeImg" />',
  'MB_playerinfo_img'      => "<img src ='/img/menu/howtoplay/dark/player_info_en_mb.png' class='changeImg' alt ='player info' />",
  ...
  'betinfo_img'            => '<img src="/img/menu/howtoplay/dark/bet_info_en.png" alt="bet info" class="changeImg" />',
  'MB_betinfo_img'         => "<img src ='/img/menu/howtoplay/dark/bet_info_en_mb.png' alt ='bet info' class='changeImg' />",
  ...
  'channels_and_limit_img'    => '<img src="/img/menu/howtoplay/dark/channels_en.png" alt="channels" class="changeImg" />',
  'MB_channels_and_limit_img' => '<img src="/img/menu/howtoplay/dark/channels_en.png" alt="channels" />',
  ...
  'betting_buttons_timer_desc'   => '
                                    ...
                                    <img src="/img/menu/howtoplay/betting_buttons_en.png" class="betting-btn" alt="betting buttons" />
                                    <p>The Undo Button
                                    <img src="/img/menu/howtoplay/undo_btn_en.png" class="undo" alt="undo" /> changes to a Repeat Button <img src="/img/menu/howtoplay/repeat_btn_en.png" class="repeat" alt="repeat"/> if you want to repeat a previous bet.</p>',
  'MB_betting_buttons_timer_desc'  => '
                                      ...
                                      <img src ="/img/menu/howtoplay/betting_buttons_en_mb.png" class ="betting-btn" alt="betting buttons" />
                                      <p>The Undo Button
                                      <img src ="/img/menu/howtoplay/undo_btn_en.png" class ="undo" alt="undo" />changes to a Repeat Button <img src="/img/menu/howtoplay/repeat_btn_en.png" class="repeat" alt="repeat"/> if you want to repeat a previous bet.</p>',

  'chips_rack_title'       => 'Chips Rack',

  'chips_rack_img'         => '<img src="/img/menu/howtoplay/chip_rack_en.png" alt="chip rack" />',
  'MB_chips_rack_img'      => "<img src ='/img/menu/howtoplay/chip_rack_en_mb.png' alt ='chip rack' />",
  ...
  'MB_menu_toggle_button_desc'  => 'Click the <img src="/img/menu/howtoplay/toggle_btn.png" class="btn--toggle" alt="toggle button" /> icon to display the full list of menu options.',

  'modify_chips_title'     => 'Modify Chips',

  'modify_chips_desc'      => '
                              To customize your chip rack based on your preference, click on the  <img src="/img/menu/howtoplay/dark/modifychips_btn_en.png" class="modify changeImg" alt="modify chips" /> button at the game menu. To modify chips, click on the chip you want to replace and click the replacement chip after. Click <img src="/img/menu/howtoplay/applychips_btn_en.png" class="apply" alt="apply chips" /> once you’re okay with your new set of chips or click <img src="/img/menu/howtoplay/dark/clearchips_btn_en.png" class="clear changeImg" alt="clear chips" /> to clear all chips and start over.',
  'MB_modify_chips_desc'   => '
                              To customize your chip rack based on your preference, Tap on the <img src="/img/menu/howtoplay/dark/modifychips_btn_mb.png" class="modify changeImg" alt="modify chips" />button at the game menu. To modify chips, tap on the chip you want to replace and tap the replacement chip after. Tap <img src="/img/menu/howtoplay/applychips_btn_en.png" class="apply" alt="apply chips" /> once you’re okay with your new set of chips or tap <img src="/img/menu/howtoplay/dark/clearchips_btn_en.png" class="clear changeImg" alt="clear chips" /> to clear all chips and start over.',

  'modify_chips_img'       => '<img src="/img/menu/howtoplay/dark/modify_chips_en.png" alt="modify chips" class="modifychips changeImg" /> ',
  'MB_modify_chips_img'    => '<img src ="/img/menu/howtoplay/dark/modify_chips_en_mb.png" alt ="modify chips" class="modifychips changeImg" /> ',
