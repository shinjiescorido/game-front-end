  ...
  <div class="container-wrap"> {{--container-wrap--}}
    <div class="container" id="SUPER-CONTAINER"> {{--container--}}
            ...
            <div class="howto-wrap__items clearfix -poker"> {{-- .howto-wrap__items --}}
              <div class="howto-submenu"> {{-- .howto-submenu --}}
                <ul class="gamerules-menu"> {{-- .gamerules-menu --}}
                  ...
                  <li class="gamerules-menu__items">
                    <a href="#poker-betpayouts"></a>
                    <span>{!! trans('howto-poker.payouts') !!}</span>
                  </li>
                  <!-- <li class="gamerules-menu__items">
                    <a href="#poker-bonuspluspayouts"></a>
                    <span>{!! trans('howto-poker.bonus_plus_payouts') !!}</span>
                  </li>
                  <li class="gamerules-menu__items">
                    <a href="#poker-pocketbonuspayouts"></a>
                    <span>{!! trans('howto-poker.pocket_bonus_payouts') !!}</span>
                  </li> -->
                  <li class="gamerules-menu__items">
              ...
              <div id="poker-top" class="howto-contents"> {{-- .howto-contents --}}
                ...
                <div id="poker-betpayouts" class="howto--layers"> {{--howto--layers--}}
          ...
          <div class="howto-wrap__items clearfix -baccarat"> {{-- .howto-wrap__items --}}
            <div class="howto-submenu"> {{-- .howto-submenu --}}
              <ul class="gamerules-menu"> {{-- .gamerules-menu --}}
                ...
                {{-- <li class="gamerules-menu__items">
                  <a href="#baccarat-speedflippytable"></a>
                  <span>{!! trans('howto-baccarat.speedy_flippy_table_baccarat') !!}</span>
                </li>  --}}
              </ul> {{-- // .gamerules-menu --}}
            </div> {{-- // .howto-submenu --}}
            ...
            <!-- <div id="baccarat-cardpositioning" class="howto--layers"> {{--howto--layers--}}
              ...
              <div class="card-positioning-wrap card-positioning__items-1 clearfix">
                <div class="card-positioning__items card-positioning__items-m clearfix">
                  <div class="card-con--inner">
                    <div class="card-con">
                      <span>{!! trans('howto-baccarat.card_positioning_1') !!}</span>
                      <img src="/img/howtoplay/mobile/baccarat/card_position_1.png" alt="9 hearts">
                    </div>
                    <div class="card-con">
                      <span>{!! trans('howto-baccarat.card_positioning_2') !!}</span>
                      <img src="/img/howtoplay/mobile/baccarat/card_position_2.png" alt="king spade">
                    </div>
                    <div class="card-con">
                      <span>{!! trans('howto-baccarat.card_positioning_3') !!}</span>
                      <img src="/img/howtoplay/mobile/baccarat/card_position_3.png" alt="ace heart">
                    </div>
                  </div>
                  <span>{!! trans('howto-baccarat.mb_banker') !!}</span>
                </div>
                <div class="card-positioning__items card-positioning__items-m clearfix">
                  <div class="card-con--inner">
                    <div class="card-con">
                      <span>{!! trans('howto-baccarat.card_positioning_4') !!}</span>
                      <img src="/img/howtoplay/mobile/baccarat/card_position_4.png" alt="9 hearts">
                    </div>
                    <div class="card-con">
                      <span>{!! trans('howto-baccarat.card_positioning_5') !!}</span>
                      <img src="/img/howtoplay/mobile/baccarat/card_position_5.png" alt="king spade">
                    </div>
                    <div class="card-con">
                      <span>{!! trans('howto-baccarat.card_positioning_6') !!}</span>
                      <img src="/img/howtoplay/mobile/baccarat/card_position_6.png" alt="ace heart">
                    </div>
                  </div>
                  <span>{!! trans('howto-baccarat.mb_player') !!}</span>
                </div>
              </div>
            </div> {{--// owto--layers--}} -->
            ...
            {{-- <div id="baccarat-dragonbonustable" class="howto--layers">
            ...
            {{-- <div id="baccarat-bigsmalltable" class="howto--layers">
              ...
              <table class="tbl--rules tbl--rules-m">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>{!! trans('howto-baccarat.mb_bigsmall_condition_1') !!}</t\d>
                  </tr>
                  <tr>
            ...
            {{-- <div id="baccarat-dragonbonus_win_sample" class="howto--layers">
              <!-- <h4>{!! trans('howto-baccarat.dragonbonus_win_sample') !!}</h4> -->
              {!! trans('howto-baccarat.mb_dragonbonus_win_sample_list') !!}
            </div> --}}
          </div> {{-- // .howto-contents --}}
          </div> {{-- // .howto-wrap__items --}}
          {{-- paste here --}}
      ...
      <div class="popup-mb-container" hidden>
        ...
        <div id="popup-gofullscreen" class="popup-fullscreen">
          <div class="popup-body-con">
            ...
            <p>{{trans('ingame.fullscreen')}}</p>
          </div>
          <div class="popup-btn-con">
            {{-- <button id="gofullscreen" type="button" name="button" class="btn-yes"><span>OK</span></button> --}}
            <button  id="exitfullscreen" type="button" name="button" class="btn-no"><span>{{trans('ingame.promptnocaps')}}</span></button>
            <button id="gofullscreen" type="button" name="button" class="btn-yes"><span>{{trans('ingame.promptyescaps')}}</span></button>
          </div>
        </div>
...
<script type="text/javascript" src="/js/dom-events-noinstall.js"></script>
