...
<!--     <button id="void">VOID</button>
    ...
    <div class="container"> {{-- .container --}}
      ...
      <div class="content-container" hidden> {{--content-container--}}
        <div class="header dom-resizable"> {{--header--}}
          <div class="header-nav clearfix"> {{--header-nav--}}
            ...
            <div class="header-nav__items header-nav--games clearfix">
              <div id="livegames" class="header-game__items -livegames active">
                <div class="header-game__items-inner">
                  <i class="ico-livegames"></i>
                  <span>{{trans('ingame.livegamescaps')}}</span>
                </div>
              </div>
              {{-- <div id="themedgames" class="header-game__items -themedgames">
                <div class="header-game__items-inner">
                  <i class="ico-themedgames"></i>
          ...
          <div class="header-subnav"> {{--header-sub-nav--}}
            <div class="header-subnav__items -baccarat active">
              <div id="baccarat" class="header-sub--target"></div>
              <div class="header-subnav--inner">
                <i class="ico-baccarat"></i>
                <span class="header-subnav--lbl">{{trans('ingame.baccaratcaps')}}</span>
              </div>
              <div class="header-subnav-nav -baccarat">
                <div id="baccarat-classic" class="header-subnav-nav__items -classic active">
                  <span>{{trans('ingame.classic')}}</span>
                </div>
                <div id="baccarat-supersix" class="header-subnav-nav__items -supersix">
                  <span>{{trans('ingame.supersix')}}</span>
                  {{-- <span class="new"> {{trans('ingame.newcaps')}}</span> --}}
                </div>
               {{-- <div id="baccarat-bonus" class="header-subnav-nav__items -bonus">
                  <span>{{trans('ingame.dragonbonuscaps')}}</span>
                  <span class="new"> {{trans('ingame.newcaps')}}</span>
                </div> --}}
              </div>
            </div>
            <div class="header-subnav__items -poker">
              <div id="poker" class="header-sub--target"></div>
              <div class="header-subnav--inner">
                <i class="ico-poker"></i>
                <span class="header-subnav--lbl">{{trans('ingame.texascaps')}}</span>
              </div>
              {{-- <span class="new"> {{trans('ingame.newcaps')}}</span> --}}
            </div>
            <div  class="header-subnav__items -sicbo">
              <div id="sicbo" class="header-sub--target"></div>
              <div class="header-subnav--inner">
                <i class="ico-sicbo"></i>
                <span class="header-subnav--lbl">{{trans('ingame.sicbocaps')}}</span>
              </div>
              <div class="header-subnav-nav -sicbo">
                <div id="sicbo-classic" class="header-subnav-nav__items -classic active">
                  <span>{{trans('ingame.classic')}}</span>
                </div>
                <div id="sicbo-userbased" class="header-subnav-nav__items -userbased">
                  <span>{{trans('ingame.rooms')}}</span>
                  <span class="new"> {{trans('ingame.newcaps')}}</span>
                </div>
              </div>
            </div>
            <div  class="header-subnav__items -dragontiger">
              <div id="dragontiger" class="header-sub--target"></div>
              <div class="header-subnav--inner">
                <i class="ico-dragontiger"></i>
                <span class="header-subnav--lbl">{{trans('ingame.dragontigercaps')}}</span>
              </div>
            </div>
            @if (Auth::user()->authority === 'a')
            <div  class="header-subnav__items -paigow">
              <div id="paigow" class="header-sub--target"></div>
              <div class="header-subnav--inner">
                <i class="ico-paigow"></i>
                <span class="header-subnav--lbl">{{trans('ingame.paigowcaps')}}</span>
              </div>
              <span class="new"> {{trans('ingame.newcaps')}}</span>
              <div class="header-subnav-nav -paigow">
                <div id="paigow-classic" class="header-subnav-nav__items -classic">
                  <span>{{trans('ingame.classic')}}</span>
                </div>
                <div id="paigow-userbased" class="header-subnav-nav__items -userbased">
                  <span>{{trans('ingame.rooms')}}</span>
                  <span class="new"> {{trans('ingame.newcaps')}}</span>
                </div>
              </div>
            ...
            @endif
            <div id="roulette" class="header-subnav__items -roulette">
              <div class="header-subnav--inner">
                <i class="ico-roulette"></i>
                <span class="header-subnav--lbl">{{trans('ingame.roulettecaps')}}</span>
              </div>
              <span class="comingsoon"> {{trans('ingame.sooncaps')}}</span>
            </div>

            <div class="header-subnav__viewstyle">
              <div class="header-subnav--inner">
                <div class="viewstyle-con viewstyle--thumb active" data="thumbnail">
                  <span></span>
                  <span></span>
                </div>
                <div class="viewstyle-con viewstyle--list" data="list">
                  <span></span>
                </div>
              </div>
            </div>

            <div class="header-subnav__sort -sicbo">
              <span class="sort-value" data-value="all">{{ trans('ingame.all') }}</span>
              <i class="ico-arrow"></i>
              <ul class="header-subnav__sortlist">
          ...
          {{--  <div class="header-subnav themedgames" hidden>
            <div class="header-subnav__items -paigow active">
              <div id="paigow" class="header-sub--target"></div>
              <div class="header-subnav--inner">
                <i class="ico-paigow"></i>
                <span class="header-subnav--lbl">{{trans('ingame.paigowcaps')}}</span>
            ...
            <div class="header-subnav__items -redwhite">
              <div id="redwhite" class="header-sub--target"></div>
              <div class="header-subnav--inner">
                <i class="ico-redwhite"></i>
                <span class="header-subnav--lbl">{{trans('ingame.redwhitecaps')}}</span>
                <span class="comingsoon"> SOON!</span>
              </div>
            </div>
            <div class="header-subnav__sort -paigow">
              <span class="sort-value" data-value="all">{{ trans('ingame.all') }}</span>
              <i class="ico-arrow"></i>
              <ul class="header-subnav__sortlist">
                <li data-value="all">{{ trans('ingame.all') }}</li>
          ...
          <div class="header-subnav reelgames" hidden> {{--header-sub-nav--}}
            {{-- <div  class="header-subnav__items -gameall active">
              <div id="gameall" class="header-sub--target"></div>
              <div class="header-subnav--inner">
                <span>{{trans('ingame.allgamescaps')}}</span>
              </div>
            </div> --}}
            <div  class="header-subnav__items -kagaming">
              <div id="kagaming" class="header-sub--target"></div>
              <div class="header-subnav--inner">
                <span class="header-subnav--lbl" style="top: -1px;">{{trans('ingame.kagamingreelcaps')}}</span>
              </div>
              {{-- <span class="new">{{trans('ingame.newcaps')}}</span> --}}
            </div>
            {{-- <div id="betsoft" class="header-subnav__items -betsoft">
              <div class="header-subnav--inner">
                <span class="header-subnav--lbl">{{trans('ingame.betsoftreelcaps')}}</span>
              </div>
              <span class="comingsoon">{{trans('ingame.sooncaps')}}</span>
            </div> --}}
          </div> {{--header-sub-nav--}}
        ...
        <div id="sidebar" class="sidebar dom-resizable">{{--sidebar--}}
          <div class="flying-lantern"> </div>
          <div class="sidebar--lobby"> {{-- sidebar--lobby--}}
            {{-- <div class="sidebar__lang">
              <i class="ico-lang ico-lang--en" data = "english" style="cursor: pointer;"></i>
              <i class="ico-lang ico-lang--jp" data = "japan" style="cursor: pointer;"></i>
              <i class="ico-lang ico-lang--kr" data = "korea" style="cursor: pointer;"></i>
              <i class="ico-lang ico-lang--zh" data = "chinese" style="cursor: pointer;"></i>
              <i class="ico-lang ico-lang--th" data = "thai" style="cursor: pointer;"></i>
            </div> --}}

            <div class="sidebar-container"> {{--sidebar-container--}}
              <div class="sidebar__con "> {{--sidebar__con--}}
                <h4><span>{{trans('ingame.livegamescaps')}}</span></h4>
                <div class="game-wrap clearfix">
                  <div class="game__col3"> {{--game__col3--}}
                    <div class="game__con game--livegames" data="sub_baccarat">
                      <div class="game__thumbnail thumb--baccarat">
                        {{-- <img src="/img/sidebar/livegames/baccarat.png" alt=""> --}}
                      </div>
                      <div class="game__name">
                        {{-- <div class="game__icon"><i class="ico-games ico-club"></i></div> --}}
                        <div class="game__lbl"><span>{{trans('ingame.baccaratcaps')}}</span></div>
                      </div>
                    </div>
                    <div class="game__con game--livegames" data="sub_poker">
                      <div class="game__thumbnail thumb--poker">
                        {{-- <img src="/img/sidebar/livegames/poker.png" alt=""> --}}
                      </div>
                      <div class="game__name">
                        {{-- <div class="game__icon"><i class="ico-games ico-club"></i></div> --}}
                        <div class="game__lbl"><span>{{trans('ingame.texascaps')}}</span></div>
                      </div>
                    </div>
                    <div class="game__con game--livegames" data="sub_sicbo">
                      <div class="game__thumbnail thumb--sicbo">
                        {{-- <img src="/img/sidebar/livegames/sicbo.png" alt=""> --}}
                      </div>
                      <div class="game__name">
                        {{-- <div class="game__icon"><i class="ico-games ico-club"></i></div> --}}
                        <div class="game__lbl"><span>{{trans('ingame.sicbocaps')}}</span></div>
                      </div>
                    </div>
                  </div> {{--// game__col3--}}

                  <div class="game__col2"> {{--game__col2--}}
                    <div class="game__con game--livegames" data="sub_dragonTiger">
                      <div class="game__thumbnail thumb--dragontiger">
                        {{-- <img src="/img/sidebar/livegames/dragontiger.png" alt=""> --}}
                      </div>
                      <div class="game__name">
                        {{-- <div class="game__icon"><i class="ico-games ico-club"></i></div> --}}
                        <div class="game__lbl"><span>{{trans('ingame.dragontigercaps')}}</span></div>
                      </div>

                    </div>
                    <div class="game__con game--livegames -soon" data="">
                      <div class="game__thumbnail thumb--roulette">
                        {{-- <img src="/img/sidebar/livegames/sicbo.png" alt=""> --}}
                      </div>
                      <div class="game__name">
                        {{-- <div class="game__icon"><i class="ico-games ico-club"></i></div> --}}
                        <div class="game__lbl"><span>{{trans('ingame.roulettecaps')}}</span></div>
                      </div>
                      <span class="game__soon">{{trans('ingame.sooncaps')}}</span>
                    </div>
                  </div> {{-- // game__col2--}}
                </div>
              </div> {{-- // sidebar__con--}}
              ...
              <div class="sidebar__con">  {{--sidebar__con--}}
                <h4><span>{{trans('ingame.themedcaps')}}</span></h4>
                <div class="game-wrap clearfix"> {{--game-wrap--}}
                  <div class="game__col2">
                    <div class="game__con game--themegames -soon">
                      <div class="game__thumbnail thumb--redwhite">
                        {{-- <img src="/img/sidebar/themedgames/redwhite.png" alt=""> --}}
                      </div>
                      <div class="game__name">
                        {{-- <div class="game__icon"><i class="ico-games ico-theme"></i></div> --}}
                        <div class="game__lbl"><span>{{trans('ingame.redwhitecaps')}}</span></div>
                      </div>
                      <span class="game__soon">{{trans('ingame.sooncaps')}}</span>
                    </div>
                    <div class="game__con game--themegames -soon">
                      <div class="game__thumbnail thumb--mahjong">
                        {{-- <img src="/img/sidebar/themedgames/spinnwin.png" alt=""> --}}
                      </div>
                      <div class="game__name">
                        {{-- <div class="game__icon"><i class="ico-games ico-theme"></i></div> --}}
                        <div class="game__lbl"><span>{{trans('ingame.paigowcaps')}}</span></div>
                      </div>
                      <span class="game__soon">{{trans('ingame.sooncaps')}}</span>
                    </div>
                  </div>
              ...
              <div class="sidebar__con"> {{--sidebar__con--}}
                <h4><span>{{trans('ingame.reelgamescaps')}}</span></h4>
                <div class="game-wrap clearfix"> {{--game-wrap--}}
                  <div class="game__col2">
                    <div class="game__con game--reelgames" data="kagaming">
                      <div class="game__thumbnail thumb--kaga" id="kaga_1">
                        {{-- <img src="/img/sidebar/reelgames/kagaming.png" alt=""> --}}
                      </div>
                      {{-- <div class="game__name"> --}}
                        {{-- <div class="game__icon"><i class="ico-games ico-reel"></i></div> --}}
                        {{-- <div class="game__lbl"><span>{{trans('ingame.kagamingreelcaps')}}</span></div> --}}
                      {{-- </div> --}}
                      {{-- <span class="game__new">{{trans('ingame.newcaps')}}</span> --}}
                    </div>

                    <div class="game__con game--reelgames" data="kagaming">
                      <div class="game__thumbnail thumb--kaga" id="kaga_2">
                        {{-- <img src="/img/sidebar/reelgames/betsoft.png" alt=""> --}}
                      </div>
                      {{-- <div class="game__name"> --}}
                        {{-- <div class="game__icon"><i class="ico-games ico-reel"></i></div> --}}
                        {{-- <div class="game__lbl"><span>{{trans('ingame.betsoftreelcaps')}}</span></div> --}}
                      {{-- </div> --}}
                      {{-- <span class="game__soon">{{trans('ingame.sooncaps')}}</span> --}}
                    </div>
            ...
            <div class="sidebar__timer"> {{--sidebar__timer--}}
              <div class="timer__items -timer">
                <span>October 13th 2017, 6:17:18PM</span>
              </div>
              <div class="timer__items -pagcor">
                <i class="ico-pagcor"></i>
                <span>PAGCOR E-CASINO</span>
              </div>
            </div> {{-- // sidebar__timer--}}
          </div> {{-- // sidebar--lobby--}}

          <div class="sidebar--game">
            <h3><span>{{trans('ingame.hotgamescaps')}}</span></h3>
            <div class="hotgame-wrap clearfix">


            </div>
            <div class="sidebar__timer" style="margin: 0 -15px;">
              <div class="timer__items -timer">
                <span>October 13th 2017, 6:17:18PM</span>
              </div>
              <div class="timer__items -pagcor">
                <i class="ico-pagcor"></i>
                <span>PAGCOR <br/> E-CASINO</span>
              </div>
            </div>
          </div>
        </div>{{-- // sidebar--}}
          ...
          <div id="top" class="howto-wrap dom-resizable"> {{-- .howto-wrap --}}
            ...
            <div class="howto-wrap__items clearfix -baccarat"> {{-- .howto-wrap__items --}}
              ...
              <div class="howto-contents"> {{-- .howto-contents --}}
                ...
                <div class="howto--layers players-hand-pc"> {{--howto--layers--}}
