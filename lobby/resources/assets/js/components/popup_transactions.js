...
export default(links) => {
	instance = instance || new blu.Component({
		...
		main() {
			...
			transHistory = new createjs.Stage("transHistory");
			this.transhistory_container = new createjs.Container();
			transHistory.addChild(this.transhistory_container)
			transHistory.enableMouseOver(10);
			...
			this.transhistory_container.x = (popup_bg.getBounds().width / 2) + 175;
			this.transhistory_container.y = -80;

			// this.regX = popup_bg.getBounds().width/2;
			// this.regY = popup_bg.getBounds().height/2;
			// this.visible = false;
	    ...
	    resize () {
			...
			transHistory.canvas.width = newWidth;
			transHistory.canvas.height = newHeight;


			transHistory.scaleX = transHistory.scaleY = newWidth / 1920;
	    }
