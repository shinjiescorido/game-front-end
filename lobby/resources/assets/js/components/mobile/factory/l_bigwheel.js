...
export default(self,data,x) => {
	instance = {
      ...
      for(let i = 0; i < self.all_list_table[x].wheelbets.length; i++) {
        self.all_list_table[x].wheelbets[i].bg.hitArea.on("mousedown", (e) => {
          if(self.all_list_table[x].wheelbets[i].text.alpha == 0) {
      ...
      self.all_list_table[x].game_marks = this.drawGameMarks(13, 6);
      self.list_view.addChild(self.all_list_table[x].game_marks.con, self.all_list_table[x].bet_range_container);
