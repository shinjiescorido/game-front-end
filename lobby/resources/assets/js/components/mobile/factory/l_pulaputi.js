...
export default(self,data,x) => {
	instance = {
		...
		createTable : function () {
			...
			self.all_list_table[x].dealer_name.y = 182 + self.all_list_table[x].y;
			self.all_list_table[x].dealer_name.textAlign = "center";

			// === timer
			self.all_list_table[x].timer.x = -2;
			self.all_list_table[x].timer.y = self.all_list_table[x].y + 30;
			...
			if(window.language.locale == "kr") {
				...
				game_rounds_label.y = 124 + self.all_list_table[x].y;
				...
				self.all_list_table[x].round_num.y = game_rounds_label.y + 2;
			...
			roadmap_bg.graphics.ss(1).s("#5e5e5e").beginFill("#3f3f3f").drawRect(0,0,432,215);
			roadmap_bg.x = 540;
			...
			for (var i = 0; i < 12; i++) {
			    ...
			    roadmapGridVer[i].graphics.setStrokeStyle(1).beginStroke("#616161").moveTo((33*i)+575, self.all_list_table[x].y).lineTo((33*i)+575, 216+self.all_list_table[x].y);
			   	self.list_view.addChild(roadmapGridVer[i]);
			}

			for (var i = 0; i < 5; i++) {
				roadmapGridHor[i] = new createjs.Shape();
			    roadmapGridHor[i].graphics.setStrokeStyle(1).beginStroke("#616161").moveTo(540, (36*i)+37+self.all_list_table[x].y).lineTo(973, (36*i)+37+self.all_list_table[x].y);
			...
			if (data.marks.length > 66) {
				self.all_list_table[x].loopStart = data.marks.length - 66;
			}
			else {
		    ...
		    self.all_list_table[x].whiteStatCircle.x = 1100;
			self.all_list_table[x].whiteStatCircle.y = 130 + self.all_list_table[x].y;
		    ...
		    self.all_list_table[x].redStatCircle.x = 1100;
			self.all_list_table[x].redStatCircle.y = 130 + self.all_list_table[x].y;
		    ...
		    self.all_list_table[x].gold2StatCircle.x = 1100;
			self.all_list_table[x].gold2StatCircle.y = 130 + self.all_list_table[x].y;
		    ...
		    self.all_list_table[x].gold1StatCircle.x = 1100;
			self.all_list_table[x].gold1StatCircle.y = 130 + self.all_list_table[x].y;
			...
			redBg2.graphics.beginFill("#7f1d1e").drawRoundRect(0, 0, 65, 30, 6);
			redBg2.x = 540;
			redBg2.y = redStatLbl.y + 130;
			self.list_view.addChild(redBg2);

			let redBg3 = new createjs.Shape();
			redBg3.graphics.beginFill("#7f1d1e").drawRoundRect(0, 0, 65, 30, 6);
			redBg3.x = redBg2.x + 72;
			redBg3.y = redStatLbl.y + 130;
			self.list_view.addChild(redBg3);

			let whiteBg2 = new createjs.Shape();
			whiteBg2.graphics.beginFill("#c4c4c4").drawRoundRect(0, 0, 65, 30, 6);
			whiteBg2.x = redBg3.x + 72;
			whiteBg2.y = redStatLbl.y + 130;
			self.list_view.addChild(whiteBg2);

			let whiteBg3 = new createjs.Shape();
			whiteBg3.graphics.beginFill("#c4c4c4").drawRoundRect(0, 0, 65, 30, 6);
			whiteBg3.x = whiteBg2.x + 72;
			whiteBg3.y = redStatLbl.y + 130;
			self.list_view.addChild(whiteBg3);

			let goldBg1 = new createjs.Shape();
			goldBg1.graphics.beginFill("#b28834").drawRoundRect(0, 0, 65, 30, 6);
			goldBg1.x = whiteBg3.x + 72;
			goldBg1.y = redStatLbl.y + 130;
			self.list_view.addChild(goldBg1);

			let goldBg2 = new createjs.Shape();
			goldBg2.graphics.beginFill("#b28834").drawRoundRect(0, 0, 65, 30, 6);
			goldBg2.x = goldBg1.x + 72;
			goldBg2.y = redStatLbl.y + 130;
			...
			self.all_list_table[x].redBg2Stat = new createjs.Text(0, '22px bebasneue', '#fff');
			self.all_list_table[x].redBg2Stat.x = redBg2.x + 60;
			...
			self.all_list_table[x].redBg3Stat = new createjs.Text(0, '22px bebasneue', '#fff');
			self.all_list_table[x].redBg3Stat.x = redBg3.x + 60;
			...
			self.all_list_table[x].whiteBg2Stat = new createjs.Text(0, '22px bebasneue', '#000');
			self.all_list_table[x].whiteBg2Stat.x = whiteBg2.x + 60;
			...
			self.all_list_table[x].whiteBg3Stat = new createjs.Text(0, '22px bebasneue', '#000');
			self.all_list_table[x].whiteBg3Stat.x = whiteBg3.x + 60;
			...
			self.all_list_table[x].goldBg1Stat = new createjs.Text(0, '22px bebasneue', '#fff');
			self.all_list_table[x].goldBg1Stat.x = goldBg1.x + 60;
			...
			self.all_list_table[x].goldBg2Stat.x = goldBg2.x + 60;
			...
			self.all_list_table[x].maintenanceLogo.x = 400;
			...
			self.all_list_table[x].maintenanceTxt.x = 570;
			...
			self.all_list_table[x].maintenanceSubTxt.x = 570;
			...
			self.all_list_table[x].maintenanceTime.x = 570;
		...
		animateDice (data) {
			...
			.wait(200)
			.to({
				x : self.all_list_table[x].resultDiceCon[x].diceCircle[this.animateResult[0]].x + 15,
				y : self.all_list_table[x].resultDiceCon[x].diceCircle[this.animateResult[0]].y + 15,
		        scaleX : 1,
		        scaleY : 1
		    }, 200)
	      	.call(() => {
		...
		pulseAnimate() {
		    createjs.Tween.get(self.all_list_table[x].resultDiceCon[x].diceCircle[this.animateResult[0]])
	      	.to({
				x : self.all_list_table[x].resultDiceCon[x].diceCircle[this.animateResult[0]].x - 2,
				y : self.all_list_table[x].resultDiceCon[x].diceCircle[this.animateResult[0]].y - 2,
		      	scaleX : 1.1,
		        scaleY : 1.1
	      	}, 150)
	      	.to({
				x : self.all_list_table[x].resultDiceCon[x].diceCircle[this.animateResult[0]].x,
				y : self.all_list_table[x].resultDiceCon[x].diceCircle[this.animateResult[0]].y,
		      	scaleX : 1,
		        scaleY : 1
	      	}, 100)
	      	.call(() => {
		...
		drawRoadMap (data) {
			...
			for (var i = self.all_list_table[x].loopStart; i < data.length; i++) {
				...
				if (result.mark == 'r') {
					roadmapResult[counter].graphics.clear().beginFill('#d32f2f').drawCircle(0, 0, 16.8);
				}
				else if (result.mark == 'w') {
					roadmapResult[counter].graphics.clear().beginFill('#fff').drawCircle(0, 0, 16.8);
				}
				else {
					roadmapResult[counter].graphics.clear().beginFill('#e5b241').drawCircle(0, 0, 16.8);
				} // end if

				roadmapResult[counter].x = (Math.floor(counter / 6) * 33.2) + 556.7;
				roadmapResult[counter].y = ((counter % 6) * 35.5) + 19 + self.all_list_table[x].y;
				...
				roadmapResultTxt[counter].x = (Math.floor(counter / 6) * 33.2) + 550;
				roadmapResultTxt[counter].y = ((counter % 6) * 35.5) + 3 + self.all_list_table[x].y;
			...
			// //Shift roadmap to left
			// if (dataCheck % 12 === 0) {
			// 	self.all_list_table[x].roadmap_con.x -= 66.4;
			// }
