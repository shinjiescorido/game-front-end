...
export default(links) => {
	instance = instance || new blu.Component({
		...
		showDetails(details) {
			...
			detailBg.graphics.setStrokeStyle(2).beginStroke('#000').beginFill('#d5d5d5').drawRoundRect(0, 0, mdlDetailWidth, 700, 7); //680
			...
			$.post(links.getBaccaratDetails, {round: details.round, table: details.table, betId: details.betId}, (response) => {
				...
				let winnerTextObj = new createjs.Text(winnerText, 'bold 36px Lato', '#fff');
				winnerTextObj.x = winnerCircle.x;
				winnerTextObj.y = winnerCircle.y - 22;
				...
				playerTotalVal.y = resultPlayerCircle.y - 21;
				...
				bankerTotalVal.y = bankerPlayerCircle.y - 21;
