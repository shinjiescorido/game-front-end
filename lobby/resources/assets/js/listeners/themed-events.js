...
const themedListen = (self) => {
    ...
    self.initThemedTable = function (data) {
        ...
        // // === make all tables
        // self.lobby_themedGames.makeListTables(themed_all_tables, self.lobby_themedGames.list_view, self.lobby_themedGames.all_list_table); //set all games data
...
const themedCallback = (param, self) => {
    ...
    hideComponents();
        switch (param) {
            case "themed_games" :
                current_open = param;
                    self.lobby_themedGames.makeListTables(themed_all_tables, self.lobby_themedGames.list_view, self.lobby_themedGames.all_list_table); //set all games data thumbnail
                    self.lobby_themedGames.visible = true;

                    //Set active sub header
                    self.lobby_themedGames_subHeader.sub_header_allGames.active(self.lobby_themedGames_subHeader.sub_header_allGames);
                    self.lobby_themedGames_subHeader.sub_header_redwhite.normal(self.lobby_themedGames_subHeader.sub_header_redwhite);
                    self.lobby_themedGames_subHeader.sub_header_spinwin.normal(self.lobby_themedGames_subHeader.sub_header_spinwin);
                break;
