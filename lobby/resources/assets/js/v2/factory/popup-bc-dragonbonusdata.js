...
let lobby_dragonbonus_data = {
    ...
    main() {
        ...
        // this._betLogs = window.baccaratLogs;
        // this._betShape = [];
        // this._betText = [];

        // //Pula-Puti log data
        // this.logs = window.baccaratLogs;
    ...
    this.betDetails.visible = false;
        ...
        $.post(links.getDragonBonusDetails, {round: details.round, table: details.table, betId: details.betId}, (response) => {
            ...
            let winnerTextObj = new createjs.Text(winnerText, 'bold 40px Lato', '#fff');
            ...
            let playerTotalVal = new createjs.Text(parseInt(totalPlayerAmt) % 10, 'bold 33px Lato', '#fff');
            playerTotalVal.x = resultPlayerCircle.x;
            playerTotalVal.y = resultPlayerCircle.y;
            playerTotalVal.textAlign = 'center';
						playerTotalVal.textBaseline = 'middle';
            ...
            let bankerTotalVal = new createjs.Text(parseInt(totalBankerAmt) % 10, 'bold 33px Lato', '#fff');
            bankerTotalVal.x = bankerPlayerCircle.x;
            bankerTotalVal.y = bankerPlayerCircle.y;
            bankerTotalVal.textAlign = 'center';
						bankerTotalVal.textBaseline = 'middle';
