...
let lobby_bonusplus_data = {
	...
	showDetails(details) {
		...
		detailBg.graphics.setStrokeStyle(2).beginStroke('#000').beginFill('#d5d5d5').drawRoundRect(0, 0, mdlDetailWidth, 790, 7);
