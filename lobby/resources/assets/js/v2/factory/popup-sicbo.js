...
let lobby_sicbo_data = {
	...
	showDetails(details) {
		...
		$.post(links.getSicboDetails, {round: details.round, table: details.table, betId: details.betId}, (response) => {
			...
			let winnerTextObj = new createjs.Text(markResultNum, '30px LatoBold', '#fff');
			...
			let tblTotalText = new createjs.Text(window.language.lobby.total, '24px LatoBold', '#231f20');
